...
function color($color = 0, $green = 0, $blue = 0, $alpha = 0) {
    fastredRequire('obj', 'str', 'var');
    ...
    if ($alpha > 0) {
        $result = sprintf("#%02x%02x%02x%02x", $red, $green, $blue, $alpha);
    } else {
...
function colorToRGBA($color) {
    $color = color($color);
    $matches = array();
    preg_match('/^#?([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})?$/', $color, $matches);
